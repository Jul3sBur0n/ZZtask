...
<html>
	...
	<body>
		...
		<input class="input-form" type="text" name="mail" id="mail" placeholder="Email"/><br/>
		<input class="input-form" type="text" name="confmail" id="confmail" placeholder="Confirmation Email"/><br/>		
		<input class="input-form" type="text" name="password" id="password" placeholder="Password" title="4 à 20 caractères"/> <br/>
